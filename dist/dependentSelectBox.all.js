...
var es_symbol_iterator = __webpack_require__(76);
...
var es_function_name = __webpack_require__(81);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.number.constructor.js
var es_number_constructor = __webpack_require__(82);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.number.is-nan.js
var es_number_is_nan = __webpack_require__(84);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.object.to-string.js
var es_object_to_string = __webpack_require__(85);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.promise.js
var es_promise = __webpack_require__(87);
...
var web_dom_collections_iterator = __webpack_require__(113);
...
var DependentSelectBox_DependentSelectBox = function DependentSelectBox(naja) {
  var _this = this;

  _classCallCheck(this, DependentSelectBox);

  _defineProperty(this, "naja", void 0);

  _defineProperty(this, "init", function () {
    var dependentSelectBoxes = document.querySelectorAll(DEPENDENT_SELECT_BOX_SELECTOR);
    ...
    try {
      var _loop = function _loop() {
        var dependentSelectBox = _step.value;

        var parents = _this.getParents(dependentSelectBox);

        parents.forEach(function (parent) {
          var element = document.getElementById(parent);

          if (element && element.getAttribute(PARENT_HAS_EVENT_LISTENER) === null) {
            element.addEventListener('change', _this.handleChange(parents, dependentSelectBoxes));
            element.setAttribute(PARENT_HAS_EVENT_LISTENER, '');
          }
        });
      };

      for (var _iterator = dependentSelectBoxes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        _loop();
      }
    } catch (err) {
  ...
  _defineProperty(this, "getParents", function (dependentSelectBox) {
    var parentsData = dependentSelectBox.getAttribute(PARENTS_DATA);
  ...
  _defineProperty(this, "getParentsData", function (form, parents) {
    var data = {};
  ...
  _defineProperty(this, "getParentValue", function (element) {
  ...
  _defineProperty(this, "handleChange", function (parents, dependentSelectBoxes) {
    return function (event) {
      ...
      try {
        for (var _iterator3 = dependentSelectBoxes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var dependentSelectBox = _step3.value;

          if (dependentSelectBox instanceof HTMLSelectElement) {
            var selectBoxParents = _this.getParents(dependentSelectBox);
      ...
      _this.handleRequest(form, dependentSelectBoxes, {
        trigger: input.id,
        data: _this.getParentsData(form, parents)
      });
    };
  });

  _defineProperty(this, "handleResponse", function (form, dependentSelectBoxes, response) {
    ...
    _this.naja.fireEvent(EVENT_LOADED, {
      form: form,
      dependentSelectBoxes: dependentSelectBoxes
    });
  });

  _defineProperty(this, "handleRequest",
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(form, dependentSelectBoxes, data) {
      var link, response;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              _this.naja.fireEvent(EVENT_LOADING, {
                form: form,
                dependentSelectBoxes: dependentSelectBoxes
              });

              _context.next = 6;
              return _this.naja.makeRequest('POST', link, data, {
                dataType: 'json',
                history: false,
                responseType: 'json'
              });
            ...
            case 6:
              ...
              _this.handleResponse(form, dependentSelectBoxes, response);
...
var global = __webpack_require__(0);
var path = __webpack_require__(31);
var NativePromise = __webpack_require__(88);
var redefine = __webpack_require__(11);
...
var hostReportErrors = __webpack_require__(100);
...
var $ = __webpack_require__(9);
var notARegExp = __webpack_require__(103);
var requireObjectCoercible = __webpack_require__(14);
var correctIsRegExpLogic = __webpack_require__(105);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(116).setImmediate, __webpack_require__(116).clearImmediate))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var naja__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(115);
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(67);


naja__WEBPACK_IMPORTED_MODULE_0___default.a.registerExtension(___WEBPACK_IMPORTED_MODULE_1__["default"]);
document.addEventListener('DOMContentLoaded', function () {
  return naja__WEBPACK_IMPORTED_MODULE_0___default.a.initialize();
});
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(38), __webpack_require__(119)))
